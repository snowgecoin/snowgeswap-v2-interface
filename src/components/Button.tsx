...
const FILLED = {
    ...
    gradient: 'w-full text-high-emphesis bg-gradient-to-r from-snowge-dark-blue to-snowge-light-blue'
}
...
const OUTLINED = {
    ...
    gradient: 'bg-gradient-to-r from-snowge-dark-blue to-snowge-light-blue'
}
